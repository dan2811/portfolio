...
function pageLayout() {
    ...
    if (bioDisplay != "none" && projectDisplay != "none" && contactSectionDisplay != "none") {
        ...
        document.body.style.gridTemplateAreas = '". heading heading heading swirl swirl""sleeveRoll sleeveRoll bioTitle . swirl swirl""sleeveRoll sleeveRoll bio bio swirl swirl""sleeveRoll sleeveRoll bio bio swirl swirl""sleeveRoll sleeveRoll linkedIn linkedIn swirl swirl""sleeveRoll sleeveRoll . . swirl swirl"". projectsHead projectsHead . swirl swirl""p1title . p2title . swirl swirl""p1image p1tech p2image p2tech swirl swirl""p1text p1text p2text p2text swirl swirl""p3title . p4title . swirl swirl""p3image p3tech p4image p4tech swirl swirl""p3text p3text p4text p4text swirl swirl"". contact contact . swirl swirl"". details details form swirl swirl"". details details form swirl swirl"". details details form swirl swirl"';
    } else if (bioDisplay != "none" && projectDisplay === "none" && contactSectionDisplay === "none") {
